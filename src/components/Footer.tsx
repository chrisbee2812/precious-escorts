      ...
      <div className="max-w-full mx-auto px-15 flex flex-col md:flex-row justify-between items-start gap-12 mb-12">
        <div className="flex flex-col gap-6">
          <Link to="/" className="flex items-center gap-2">
            <span className="text-xl font-display tracking-[0.2em] uppercase text-accent">Velvet Rose</span>
          </Link>
        ...
        <div className="max-w-100">
          <p className="text-[9px] uppercase tracking-[0.15em] text-white/30 leading-relaxed">
            VELVET ROSE OPERATES IN FULL COMPLIANCE WITH LOCAL LAWS. WE FACILITATE INTRODUCTIONS FOR COMPANIONSHIP ONLY. ALL INDIVIDUALS ARE INDEPENDENT ADULTS.
          </p>
        </div>

        <div className="text-[10px] uppercase tracking-[0.2em] text-white/40">
          <p>© {currentYear} Velvet Rose</p>
        </div>
      </div>
    </footer>
  );
